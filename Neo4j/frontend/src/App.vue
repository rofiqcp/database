  ...
  <div :class="{ 'dark': darkMode }">
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">Graph Database CRUD Application</p>
            </div>
            <button
      ...
      <main class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <!-- Tabs -->
        <div class="mb-6 flex gap-2 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
          <button
            v-for="tab in tabs"
            :key="tab"
            @click="activeTab = tab"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <DetailView v-if="activeTab === 'Detail'" :item="selectedItem" @edit="handleEdit" />
      ...
      <footer class="mt-12 py-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-600 dark:text-gray-400">
          Neo4j Learning Module - Built with Vue 3, Vite, and TailwindCSS
        </div>
      </footer>
    </div>
  </div>
...
const tabs = ['List', 'Create', 'Edit', 'Detail', 'Search', 'Graph']
