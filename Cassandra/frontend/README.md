# Cassandra Frontend - Learning Module

Vue 3 + Vite frontend application for Cassandra database with full CRUD UI.
...
- Shortened UUID display with full ID on hover
...
### DataTable.vue
Displays all items in a responsive table with actions. UUIDs are shortened for display.
...
### DetailView.vue
Displays detailed view of a single item with full UUID.
