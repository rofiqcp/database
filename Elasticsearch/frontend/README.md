# Elasticsearch Frontend - Learning Module

Vue 3 + Vite frontend application for Elasticsearch database with full CRUD UI.
...
- Truncated document IDs for readability
...
- Full document ID display
- Formatted display

### 5. Search & Filter
- Search by name/description (powered by Elasticsearch full-text search)
- Filter by category
...
### DataTable.vue
Displays all items in a responsive table with actions. Document IDs are truncated for display.
...
### DetailView.vue
Displays detailed view of a single item including full document ID.

### SearchFilter.vue
Advanced search and filter interface powered by Elasticsearch query DSL.
