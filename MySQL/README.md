...
│   ├── data/            # MySQL database (auto-created)
│   ├── package.json
│   ├── .env.example
│   └── README.md
...
- **Database**: MySQL with node-mysql (pg)
...
- **Production Applications**: MySQL is production-ready
...
- [ ] Export to CSV/PDF
- [ ] Bulk operations
- [ ] Advanced filtering with MySQL full-text search
- [ ] User preferences
- [ ] JSONB columns for flexible data
- [ ] Database migrations with tools like Knex
- [ ] MySQL-specific features (CTEs, window functions)
