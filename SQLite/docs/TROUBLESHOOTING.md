...
Common issues and solutions for the SQLite Learning Module.
...
- Python or build tools not found
...
sqlite3 backend/data/database.db "SELECT * FROM items LIMIT 1;"
...
# Check for many rows
sqlite3 backend/data/database.db "SELECT COUNT(*) FROM items;"
```
