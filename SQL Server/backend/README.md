# SQL Server Backend - Learning Module

Node.js + Express backend server for SQL Server database operations with full CRUD API.

## Features

- ✅ RESTful API with Express.js
- ✅ SQL Server database with mssql driver
...
- npm or yarn
- SQL Server instance (Express, Standard, or Enterprise)
