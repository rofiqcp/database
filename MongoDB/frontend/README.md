# MongoDB Frontend - Learning Module

Vue 3 + Vite frontend application for MongoDB database with full CRUD UI.
...
MongoDB uses `_id` (ObjectId string) instead of integer IDs. All components reference `item._id` for identification. ObjectIds are 24-character hexadecimal strings (e.g., `65a1b2c3d4e5f6a7b8c9d0e1`).
