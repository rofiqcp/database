...
### ✅ Database Operations
- **MongoDB Integration**: Document database with official Node.js driver
- **Auto-initialization**: Database, collection, and indexes created automatically on first run
- **Index Management**: Pre-defined indexes on category and name fields
- **Data Persistence**: All data stored in MongoDB server
...
- **NoSQL Injection Prevention**: Parameterized queries with official driver
- **ObjectId Validation**: Regex validation for 24-char hex string format
...
- **Filtering**: Multiple filter criteria using MongoDB query operators
- **Regex Search**: Case-insensitive regex search across fields
...
- **Docker**: Can be containerized with MongoDB
...
- **MongoDB Indexes**: Fast queries on category and name
...
- Learning NoSQL/MongoDB concepts
