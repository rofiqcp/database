    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">Full-stack CRUD application with AWS SDK v3</p>
            </div>
            <button
      ...
      <footer class="mt-12 py-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-600 dark:text-gray-400">
          DynamoDB Learning Module - Built with Vue 3, Vite, TailwindCSS, and AWS SDK v3
        </div>
      </footer>
    </div>
  </div>
