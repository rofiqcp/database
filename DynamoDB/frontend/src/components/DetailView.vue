    ...
    <div v-else class="space-y-4">
      <div class="grid grid-cols-2 gap-4">
        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">ID</p>
          <p class="text-sm font-mono text-gray-900 dark:text-white break-all">{{ item.id }}</p>
        </div>
        ...
        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          ...
          <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ item.category || '-' }}</p>
        </div>

        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Price</p>
          <p class="text-lg font-semibold text-gray-900 dark:text-white">${{ item.price?.toFixed(2) || '0.00' }}</p>
        </div>

        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Stock</p>
          <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ item.stock || 0 }}</p>
        </div>

        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Created At</p>
          <p class="text-sm text-gray-900 dark:text-white">{{ formatDate(item.createdAt) }}</p>
        </div>

        <div class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg col-span-2">
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Updated At</p>
          <p class="text-sm text-gray-900 dark:text-white">{{ formatDate(item.updatedAt) }}</p>
        </div>
      </div>
